...
(3,1,3,'有机旱黄瓜','/api/images/VCG211450687680.webp','["/api/images/VCG211450687680.webp","/api/images/VCG211450687680.webp"]',4.90,6.90,720,'500g/袋','通过有机种植管理，口感清脆，冷藏后风味更佳',143,1,3,NOW(),NOW(),0),
(4,1,1,'红富士苹果礼盒','/api/images/VCG211415338609.webp','["/api/images/VCG211415338609.webp","/api/images/VCG211415338609.webp"]',21.80,27.80,640,'2kg/箱','精选中大果，脆甜爽口，适合家庭和送礼',238,1,4,NOW(),NOW(),0),
(5,1,2,'奶油生菜','/api/images/VCG211375299502.webp','["/api/images/VCG211375299502.webp","/api/images/VCG211375299502.webp"]',4.80,6.20,580,'300g/份','叶片鲜嫩，适合轻食沙拉和火锅配菜',122,1,5,NOW(),NOW(),0),
(6,1,1,'麒麟西瓜小果','/api/images/VCG211583441112.webp','["/api/images/VCG211583441112.webp","/api/images/VCG211583441112.webp"]',18.90,24.90,240,'约2.5kg/个','单果约2.5kg，皮薄瓤红，冷藏口感更佳',175,1,6,NOW(),NOW(),0),
(7,1,3,'有机上海青','/api/images/VCG211564814308.webp','["/api/images/VCG211564814308.webp","/api/images/VCG211564814308.webp"]',5.80,7.80,500,'500g/袋','基地当日采收，叶梗脆嫩，适合清炒或汆烫',110,1,7,NOW(),NOW(),0),
(8,1,3,'贝贝南瓜','/api/images/VCG211429867102.webp','["/api/images/VCG211429867102.webp"]',8.90,11.90,430,'900g/个','粉糯香甜，蒸烤皆宜，家庭常备食材',98,1,8,NOW(),NOW(),0)
